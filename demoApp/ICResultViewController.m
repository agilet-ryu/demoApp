...
@interface ICResultViewController ()<UIWebViewDelegate, hudViewDelegate, faceIDManagerDelegate>
...
- (void)didChecked:(UIButton *)button{
    ...
    self.readButton.backgroundColor = button.isSelected ? [UIColor colorWithHexString:[UITool shareUITool].baseColorHexString alpha:0.3f] : [UIColor whiteColor];
    self.readButton.layer.borderColor = button.isSelected ? [UIColor clearColor].CGColor : [UIColor colorWithHexString:[UITool shareUITool].baseColorHexString alpha:1.0f].CGColor;
    self.readButton.userInteractionEnabled = !button.isSelected;
    button.isSelected ? [self.readButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal] : [self.readButton setTitleColor:[UIColor colorWithHexString:[UITool shareUITool].baseColorHexString alpha:1.0f] forState:UIControlStateNormal];
